"""
Django settings for brite project.
...
SECRET_KEY = 'dody-r15$2y1r^8q93-ac976ep073^c(^zrkd6_y7ogz2x3xu*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']
ADMINS = ('eolowo@live.com',)
...
WSGI_APPLICATION = 'brite.wsgi.application'
