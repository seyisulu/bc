  ...
  Menu: {
    ...
    children: [
      ...
      },
      {
        name: 'Content8_0',
        to: 'Content8_0',
        children: 'Content 8.0',
        className: 'menu-item',
      },
      {
        name: 'Content9_0',
        to: 'Content9_0',
        children: 'Content 9.0',
        className: 'menu-item',
      },
      {
        name: 'Content10_0',
        to: 'Content10_0',
        children: 'Content 10.0',
        className: 'menu-item',
      },
      {
        name: 'Content11_0',
  ...
  textWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        children: 'Banner 3 slogan',
        texty: true,
      },
      {
        name: 'name',
        className: 'banner3-name',
        children: 'Banner 3 name',
      },
      { name: 'button', className: 'banner3-button', children: 'Banner 3 Button' },
      {
        name: 'time',
...
export const Footer20DataSource = {
  ...
  copyright: {
    ...
    children: [
      ...
      {
        name: 'copyright',
        children: 'Copyright © Emmanuel Olowosulu',
